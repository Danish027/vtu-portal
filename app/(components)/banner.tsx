...
const Banner = () => {
  return (
    <div className="mx-autopx-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
      ...
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-6xl">
        <span className="inline-block">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">Gateway </span>
          </span>
        </span>{" "}
        <span className="inline-block sm:mt-8">to Academic Resources</span>
      </h1>

      <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        <span className="inline-block">Explore, Learn, Succeed</span>
      </p>
